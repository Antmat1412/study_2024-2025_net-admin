...
![Настройка доступа к файловому серверу](image/11.4.png){#fig:012 width=70%}
...
![Проверка доступности устройств с dk-donskaya-aiamunichnikov-1](image/20.png){#fig:023 width=70%}
